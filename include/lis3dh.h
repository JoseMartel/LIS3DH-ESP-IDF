...
// SPI Config
// #define SPI_PIN_NUM_MISO  19    // Pin de datos MISO
// #define SPI_PIN_NUM_MOSI  23    // Pin de datos MOSI
// #define SPI_PIN_NUM_CLK   18    // Pin de reloj SPI
// #define SPI_PIN_NUM_CS    2    // Pin de selección del dispositivo
// #define SPI_CLOCK_SPEED  1000000   // Velocidad del reloj SPI en Hz

// I2C Config
#define I2C_MASTER_SCL_IO           19 //22                        /*!< GPIO number used for I2C master clock */
#define I2C_MASTER_SDA_IO           18 //21                        /*!< GPIO number used for I2C master data  */
...
// I2C ADDRESS
#define LIS3DH_MEMS_I2C_ADDRESS			    0x18//0x33

// Constant for gravity
#define CONST_GRAVITY 9.80665

// Scale Modifiers
#define LIS3DH_ACCEL_SCALE_MODIFIER_2G    16384.0
#define LIS3DH_ACCEL_SCALE_MODIFIER_4G    8192.0
#define LIS3DH_ACCEL_SCALE_MODIFIER_8G    4096.0
#define LIS3DH_ACCEL_SCALE_MODIFIER_16G   2048.0

#define LIS3DH_ACCEL_SCALE_MODIFIER_2G_LP    64.0
#define LIS3DH_ACCEL_SCALE_MODIFIER_4G_LP    32.0
...
#define LIS3DH_ODR_BIT			BitMask(4)
#define LIS3DH_LPEN					BitMask(3)
#define LIS3DH_ZEN					BitMask(2)
#define LIS3DH_YEN					BitMask(1)
#define LIS3DH_XEN					BitMask(0)

//CONTROL REGISTER 2
#define LIS3DH_CTRL_REG2				0x21
#define LIS3DH_HPM     				BitMask(6)
#define LIS3DH_HPCF					BitMask(4)
#define LIS3DH_FDS					BitMask(3)
#define LIS3DH_HPCLICK					BitMask(2)
#define LIS3DH_HPIS2					BitMask(1)
#define LIS3DH_HPIS1					BitMask(0)

//CONTROL REGISTER 3
#define LIS3DH_CTRL_REG3				0x22
#define LIS3DH_I1_CLICK				BitMask(7)
#define LIS3DH_I1_AOI1					BitMask(6)
#define LIS3DH_I1_AOI2				        BitMask(5)
#define LIS3DH_I1_DRDY1				BitMask(4)
#define LIS3DH_I1_DRDY2				BitMask(3)
#define LIS3DH_I1_WTM					BitMask(2)
#define LIS3DH_I1_ORUN					BitMask(1)

//CONTROL REGISTER 6
#define LIS3DH_CTRL_REG6				0x25
#define LIS3DH_I2_CLICK				BitMask(7)
#define LIS3DH_I2_INT1					BitMask(6)
#define LIS3DH_I2_BOOT         			BitMask(4)
#define LIS3DH_H_LACTIVE				BitMask(1)

//TEMPERATURE CONFIG REGISTER
#define LIS3DH_TEMP_CFG_REG				0x1F
#define LIS3DH_ADC_PD				        BitMask(7)
#define LIS3DH_TEMP_EN					BitMask(6)

//CONTROL REGISTER 4
#define LIS3DH_CTRL_REG4				0x23
#define LIS3DH_BDU					BitMask(7)
#define LIS3DH_BLE					BitMask(6)
#define LIS3DH_FS					BitMask(4)
#define LIS3DH_HR					BitMask(3)
#define LIS3DH_ST       				BitMask(1)
#define LIS3DH_SIM					BitMask(0)

//CONTROL REGISTER 5
#define LIS3DH_CTRL_REG5				0x24
#define LIS3DH_BOOT                                    BitMask(7)
#define LIS3DH_FIFO_EN                                 BitMask(6)
#define LIS3DH_LIR_INT1                                BitMask(3)
#define LIS3DH_D4D_INT1                                BitMask(2)

//REFERENCE/DATA_CAPTURE
#define LIS3DH_REFERENCE_REG		                   0x26
#define LIS3DH_REF		                	           BitMask(0)

//STATUS_REG_AXIES
#define LIS3DH_STATUS_REG				                0x27
#define LIS3DH_ZYXOR                                   BitMask(7)
#define LIS3DH_ZOR                                     BitMask(6)
#define LIS3DH_YOR                                     BitMask(5)
#define LIS3DH_XOR                                     BitMask(4)
#define LIS3DH_ZYXDA                                   BitMask(3)
#define LIS3DH_ZDA                                     BitMask(2)
#define LIS3DH_YDA                                     BitMask(1)
#define LIS3DH_XDA                                     BitMask(0)
...
#define LIS3DH_ANDOR                                   BitMask(7)
#define LIS3DH_INT_6D                                  BitMask(6)
#define LIS3DH_ZHIE                                    BitMask(5)
#define LIS3DH_ZLIE                                    BitMask(4)
#define LIS3DH_YHIE                                    BitMask(3)
#define LIS3DH_YLIE                                    BitMask(2)
#define LIS3DH_XHIE                                    BitMask(1)
#define LIS3DH_XLIE                                    BitMask(0)

//FIFO CONTROL REGISTER
#define LIS3DH_FIFO_CTRL_REG                           0x2E
#define LIS3DH_FM                                      BitMask(6)
#define LIS3DH_TR                                      BitMask(5)
#define LIS3DH_FTH                                     BitMask(0)
